...
--local mocp_widget = require('awesome-wm-widgets.mocp-widget.mocp')
...
theme.taglist_font                              = "Liberation Sans 14"
...
--My Test
local testicon = wibox.widget.imagebox(theme.widget_vol)
local testclock = awful.widget.watch(
    "/home/phil/.config/awesome/themes/powerarrow-blue/date.sh", 60,
...
theme.weather = lain.widget.weather({
    city_id = 2643259, -- placeholder (Machen)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --wibox.container.background(wibox.container.margin(testclock, 4, 8), "#006666"),
           ...
           arrow("alpha", "#006666"),
            wibox.container.background(wibox.container.margin(wibox.widget {  volume_widget(), layout = wibox.layout.align.horizontal }, 3, 6), "#006666"),
            arrow("#006666", "#330066"),
            wibox.container.background(wibox.container.margin(wibox.widget { ram_widget(), layout = wibox.layout.align.horizontal }, 2, 3), "#330066"),
            arrow("#330066", "#006666"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#006666"),
            arrow("#006666", "#330066"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, 3, 4), "#330066"),
            arrow("#330066", "#006666"),
            ...
            --arrow("#7197E7", "#A77AC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { weathericon, theme.weather.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#006666"),
            arrow("#006666","#330066"),
           -- wibox.container.background(wibox.container.margin(wibox.widget { baticon, mem.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#006666"),
           -- arrow("#006666", "#330066"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#330066"),
            arrow("#330066", "#006666"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#006666"),
            arrow("#006666", "alpha"),
            --]]
            s.mylayoutbox,
        },
