...
sudo apt install -y openbox obconf lxappearance lxappearance-obconf tint2 git lxtask feh xterm cairo-dock cairo-dock-gnome-integration-plug-in cairo-dock-plug-ins
